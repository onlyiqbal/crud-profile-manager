    ...
    <div class="mb-3 row">
        ...
        <div class="col-md-6">
            <input type="password" name="password" id="password"
                ...
                value="{{ old('password') ?? ($user->password ?? '') }}" autocomplete="new-password">
            @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
...
<div class="mb-3 row">
    ...
    <div class="col-md-6">
        <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror"
            value="{{ old('nama') ?? ($user->nama ?? '') }}" autocomplete="nama">
        @error('nama')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="row g-2">
            <div class="col-3">
                <input type="number" name="tgl" id="tgl"
                    class="form-control col-md-3 d-inline @error('tgl') is-invalid @enderror" placeholder="dd"
            ...
            <div class="col-5">
                ...
                <select name="bln" id="bln"
                    class="form-select col-md-4 d-inline @error('bln') is-invalid @enderror"
...
<div class="mb-3 row">
    ...
    <div class="col-md-6">
        <img id="display_gambar_profil" class="img-thumbnail w-25 mb-2"
            @if ($tombol == 'Daftar') src="{{ asset('img/default_profile.jpg') }}"
...
<div class="mb-3 row">
    ...
    <div class="col-md-6">
        <select name="background_profil"
            class="form-select col-md-5 @error('background_profil') is-invalid @enderror" id="background_profil">
            @for ($i = 1; $i <= 12; $i++)
